...
def _download_from_source():
    ...
    for pm in placemarks:
        ...
        result['place_names'] = [el.text.strip() for el in pm.select('extendeddata data[name="Place names"] value')]
        result['twitter_account'] = pm.select_one('extendeddata data[name="Twitter account"] value').text.strip()
        result['original_outlet'] = pm.select_one('extendeddata data[name="Original outlet"] value').text.strip()
        result['original_outlet_link'] = pm.select_one('extendeddata data[name="Link to original outlet"] value').text.strip()
