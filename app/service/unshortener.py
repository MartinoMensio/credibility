...
more_shortening_domains = {
    "cnn.it",
    "strw.rs",
    "to.pbs.org",
    "m.eonline.com" "nyer.cm",
    "s.nj.com",
    "narrative.ly",
    "bloom.bg",
    "n.pr",
    ...
    "www.cue.org",
    "www.whitehouse.gov",
    "m.foreignaffairs.com",
    "nytimes.com",
    "go.unimelb.edu.au",
    "telegraph.co.uk",
    "doajournals.wordpress.com",
    "wp.me",
    "ahwd.tv",
    "glasgow.ac.uk",
    "spr.ly",
    ...
    "rewirenews.link",
    "cwrld.us",
    "littlerebelsaward.wordpress.com",
    "on.nypl.org",
    "turkeyonthehill.blogspot.co.uk",
    "francisgilbert.co.uk",
    "boxlun.ch",
    "www.orlandosentinel.com",
    "www.newschallenge.org",
    "urbn.is",
    "librarywriting.blogspot.co.uk",
    "realtwitter.com",
    "sage-ereference.com",
    "ebks.to",
    ...
    "www.open.ac.uk",
    "pedagogicalpurposes.blogspot.co.uk",
    ...
    "www.savvysugar.com",
    "guardian.co.uk",
    "superhero.namegeneratorfun.com",
    "www.bloombergview.com",
    "www.mentalfloss.com",
    "interc.pt",
    "po.st",
    "edcampbr.eventbrite.com",
    "patreon.com",
    "ncdps.gov",
    ...
    "www.guardian.co.uk",
    "bobrosslipsum.com",
    "edcampglobal.wixsite.com",
    "kck.st",
    "wapo.st",
    "www.slate.com",
    "imdb.me",
    "www.flelibrary.org",
    "search-proquest-com.lp.hscl.ufl.edu",
    "ln.is",
    ...
    "android.com",
    "poynter.org",
    "lockerhullthornton.com",
    "www.ingodwetrust.tv",
    "ylgunconference-estw.eventbrite.co.uk",
    ...
    "invite.overtone.co",
    "snpy.tv",
    "edcampbr16.eventbrite.com",
    "media.rawvoice.com",
    "www.radioopensource.org",
    "jwatch.us",
    "adweek.it",
    "hill.cm",
    "retweets.realtwitter.com",
    "ny.gov",
    "badgelist.com",
    ...
    "cnn.com",
    "ready.gov",
    "tommy-on-tour-2011.blogspot.co.uk",
    "cmore.pics",
    "ti.me",
    "loc.gov",
    "dcgov.github.io",
    "anglandicus.blogspot.ie",
    "ripl.com",
    "di.sn",
    "aclj.us",
    "oxford.ly",
    ...
    "docs.google.com",
    "thehateugive.com",
    "ayame-kenoshi.deviantart.com",
    "on.today.com",
    "on.apa.org",
    "deadsp.in",
    "www.supplymanagement.com",
    "membership.politifact.com",
    "www.theonion.com",
    "db.tt",
    "www.quillandquire.com",
    "executive.nd.edu",
    "mightylittlelibrarian.com",
    "patthomson.wordpress.com",
    "hangouts.google.com",
    "raisingreaderssite.wordpress.com",
    "arvr.kmi.open.ac.uk",
    ...
    "meetu.ps",
    "nyp.st",
    "sarahmarshall3.tumblr.com",
    "undf.td",
    "smore.com",
    "scribblestreetnews.blogspot.co.uk",
    ...
    "thebeautifulnecessity.blogspot.co.uk",
    ...
    "got.cr",
    "onion.com",
    "totallybookalicious.blogspot.co.uk",
    "sco.lt",
    "ala.org",
    "nie.mn",
    "www.all4ed.org",
    ...
    "edtru.st",
    "battleforthenet.com",
    "businesslibrary.uflib.ufl.edu",
    "www.leave.eu",
    "cnb.cx",
    "pens.pe",
    "next.srds.com",
    "jonmayhem.blogspot.co.uk",
    "politifact.com",
    ...
    "thedo.do",
    "trendsmap.com",
    "m.burnleyexpress.net",
    "www.thebookoflife.org",
    "i100.io",
    "soa.li",
    "www.markthomasinfo.co.uk",
    "drudge.tw",
    "edcampbr17.eventbrite.com",
    "ufl.kanopystreaming.com",
    "53eig.ht",
    "adf.ly",
    "skills.oecd.org",
    "shar.es",
    "studenthublive.kmi.open.ac.uk",
    "s.si.edu",
    "wesa.fm",
    "conta.cc",
    "usatoday.com",
    ...
    "usfreedomarmy.com",
    "s.silive.com",
    "www.unisoncambridgeshire.org.uk",
    "m.us.wsj.com",
    ...
    "sbnation.com",
    "wsj.com",
    "fannycornforth.blogspot.co.uk",
    "met.org",
    "politi.co",
    "chng.it",
    "vult.re",
    "elisoriano.com",
    "datasciencechallenge.org",
    "www.wellcome.ac.uk",
    "huffp.st",
    "on.learn4startup.com",
    ...
    "cbsn.ws",
    "dailym.ai",
    "lifeartcollide.blogspot.ca",
    "engt.co",
    "thedaringlibrarianpresents.wikispaces.com",
    "screencast.com",
    "boston25.com",
    "izvestia.ru",
    "dailysignal.com",
    "www.ppehlab.org",
    "cyberoptixtielab.myshopify.com",
    "awe.sm",
    "yhoo.it",
    "scim.ag",
    "pythonanywhere.com",
    ...
    "www.eudebateni.org",
    "ubm.io",
    "skrashen.blogspot.hk",
    "thesco.re",
    "mnky.in",
    "lat.ms",
    "on.freep.com",
    "www.speakupforlibraries.org",
    "www.blackmarket14.eventbrite.co.uk",
    "patabot.etsy.com",
    ...
    "rauviel.etsy.com",
    "t.ted.com",
    "votelibraries.nationbuilder.com",
    "pewrsr.ch",
    "demsoc.org",
...
def unshorten_multiprocess(url_list, pool_size=20):
    ...
    with ThreadPool(pool_size) as pool:
        ...
        for one_result in tqdm.tqdm(
            pool.imap_unordered(func, url_not_found), total=len(url_not_found)
        ):
